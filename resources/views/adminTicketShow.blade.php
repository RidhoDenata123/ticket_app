                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control" value="{{ $ticket->tgl_bayar == '2001-01-01 00:00:00' ? 'N/A' : $ticket->tgl_bayar }}" readonly>
                                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="modal-footer">
                                                        ...
                                                        <div class="btn-group">
                                                            <a href="/admin/ticket" class="btn btn-md btn-dark me-4">OK</a>
                                                        </div>	
