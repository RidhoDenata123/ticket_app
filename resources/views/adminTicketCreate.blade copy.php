                                    ...
                                    <form action="{{ route('ticket.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mb-3">
                                                            <label class="font-weight-bold">ID USER (pemesan)</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control @error('ticket_price') is-invalid @enderror" name="ticket_price" id="ticket_price" value="{{ old('ticket_price') }}" placeholder="Harga Ticket" readonly>
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control @error('cost_kendaraan') is-invalid @enderror" name="cost_kendaraan" id="cost_kendaraan" value="{{ old('cost_kendaraan') }}" placeholder="Cost Kendaraan" readonly>
                                        ...
                                        <!-- hidden stuff -->
                                            ...
                                            <input type="hidden" class="form-control" name="tgl_bayar"  value="">
