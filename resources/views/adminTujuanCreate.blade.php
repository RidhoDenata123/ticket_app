                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('tujuan.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control @error('nama_tujuan') is-invalid @enderror" name="nama_tujuan" value="{{ old('nama_tujuan') }}" placeholder="Masukkan Tujuan Perjalanan">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control @error('desc_tujuan') is-invalid @enderror" name="desc_tujuan" rows="5" placeholder="Masukkan deskripsi tujuan">{{ old('desc_tujuan') }}</textarea>
                                            ...
                                            <div class="form-group mb-3">
                                                        ...
                                                        <input type="number" class="form-control @error('ticket_price') is-invalid @enderror" name="ticket_price" value="{{ old('ticket_price') }}" placeholder="Masukkan Harga Ticket">
